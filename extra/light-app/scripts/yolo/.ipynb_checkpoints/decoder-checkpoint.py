...
class  YoloDecodeNetout():
    ...
    def detect_video(self,Yolo, video_path, output_path='', input_size=416, show=False, score_threshold=0.3, iou_threshold=0.45, rectangle_colors=''):
        times, times_2 = [], []
    ...
    def detect_images(self,Yolo, img_path, output_path='', input_size=416, show= False, score_threshold=0.3, iou_threshold=0.45, rectangle_colors=''):
        times, times_2 = [], []
    ...
    def detect_image(self,Yolo, path, output_path='', input_size=416, show=True, score_threshold=0.3, iou_threshold=0.45, rectangle_colors=''):
        times, times_2 = [], []
